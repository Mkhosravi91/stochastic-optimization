...
### **Putting Everything Together**  
   • Summarize the pipeline:  
     1. To run the model, place both surplus.gms and the K-Means output file (inputs.xlsx) into C:\Users\<your-Windows-username>\Documents\gamsdir\projdir (replacing 
        <your-Windows-username> with whatever folder name you see under C:\Users\). Then, from a terminal opened in that folder, execute: surplus.gms lo=2.  
